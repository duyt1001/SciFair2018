...
def open1():
    PathPy = '/users/anna/Desktop/annagreenballdetector.py'
    os.system('%s %s' % (pyexec, PathPy))
def open2():
    PathPy = '/users/anna/Desktop/comparison850and950nma.py'
    os.system('%s %s' % (pyexec, PathPy))
def open3():
    PathPy = '/users/anna/Desktop/orangedetectorFIXED.py'
    os.system('%s %s' % (pyexec, PathPy))
def open4():
    PathPy = '/users/anna/Desktop/purpledetectorFIXED.py'
    os.system('%s %s' % (pyexec, PathPy))
def open5():
    PathPy = '/users/anna/Desktop/chartreusedetectorFIXED.py'
    os.system('%s %s' % (pyexec, PathPy))
def open6():
    PathPy = '/users/anna/Desktop/visible850950.jpg'
    os.system('%s %s' % (pyexec, PathPy))
...
btn3 = Button(window, command=open, text="Blue", font=("Arial Bold",25), height=2, padx=2, foreground="blue")
btn3.grid(column=10, row=40, sticky="w")

btn4 = Button(window, command=open5, text="Chartreuse", font=("Arial Bold",25), height=2, foreground="green")
btn4.grid(column=10, row=45, sticky="w")

btn5 = Button(window, command=open4, text="Purple", font=("Arial Bold",25), height=2, foreground="purple")
btn5.grid(column=10, row=50, sticky="w")

btn6 = Button(window, command=open3, text="Orange", font=("Arial Bold",25), height=2, foreground="orange")
