...
myimg = cv2.imread('/Users/anna/Downloads/irpic1.jpg')
avg_color_per_row = np.average(myimg, axis=0)
avg_color = np.average(avg_color_per_row, axis=0)
avgimghist = int(avg_color[0])

meimg = cv2.imread('/Users/anna/Downloads/irpic2.jpg')
avg_color_per_row = np.average(meimg, axis=0)
avg_color = np.average(avg_color_per_row, axis=0)
avgimghisto = int(avg_color[0])


myimg = cv2.imread('/Users/anna/Downloads/irpic1.jpg',0)
rows,cols = myimg.shape


meimg = cv2.imread('/Users/anna/Downloads/irpic2.jpg',0)
rows,cols = meimg.shape

thisimg = cv2.imread('/Users/anna/Downloads/irpic1.jpg')
...
cv2.imwrite('/Users/anna/Downloads/combinedpicturesofplastics.jpg',thisimg)
